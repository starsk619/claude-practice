 ...
 * summarizer 모듈의 진입점.
 *
 * 책임: NewsItem[] 을 입력받아 카테고리별(AI 뉴스 / 주식 뉴스) 한글 요약을 생성하고
...
/**
 * NewsItem[] 을 받아 카테고리별(AI 뉴스 / 주식 뉴스) 한글 요약을 생성한다.
 *
...
export async function summarizeNews(newsItems) {
  ...
  for (const category of CATEGORIES) {
    ...
    // eslint-disable-next-line no-await-in-loop -- 카테고리 수가 적고(2개), 순차 처리로 충분함
