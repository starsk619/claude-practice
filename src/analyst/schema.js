  ...
  properties: {
    ...
    picks: {
      ...
      description:
        ...
        '있지 않지만, 특별한 이유가 없다면 등급별로 대략 2개를 기본으로 하고, 근거가 풍부하면 ' +
        '3개까지, 근거가 빈약하면 0~1개로 줄일 것. 단순히 "대표 1개면 충분하다"는 식으로 안일하게 ' +
        '최소화하지 말 것. 근거 없는 추측성 종목 추천은 피할 것. 잘 알려지지 않은 소형/동전주는 ' +
        '굳이 포함하지 말고, 가급적 이름을 들으면 알 만한 잘 알려진 기업 위주로 선정할 것(특히 ' +
        '"주의" 등급은 "잘 알려졌지만 지금은 위험 요인이 있는 기업" 위주가 유용함).',
      items: {
        type: Type.OBJECT,
        properties: {
          ticker: {
